  ...
  return (
    <>
      <div className="flex gap-4">
        <button className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-solid hover:bg-stroke border-stroke p-3.5 text-dark duration-200 ease-in hover:border-gray-5 hover:bg-grey dark:border-border_color dark:text-white dark:hover:bg-darklight">
          Sign In
          <svg
            width="23"
            height="22"
